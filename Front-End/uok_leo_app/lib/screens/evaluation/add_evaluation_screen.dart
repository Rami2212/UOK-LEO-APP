...
class AddEvaluationScreen extends StatefulWidget {
  @override
  _AddEvaluationScreenState createState() => _AddEvaluationScreenState();
}
...
class _AddEvaluationScreenState extends State<AddEvaluationScreen> {
  ...
  void _submitEvaluation() async {
    if (_formKey.currentState!.validate()) {
      ...
      bool success = await _evaluationRepository.addEvaluation(newEvaluation);

      if (success) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Evaluation added successfully")));
        Navigator.pop(context);
      } else {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Failed to add evaluation")));
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Add Evaluation")),
      body: Padding(
