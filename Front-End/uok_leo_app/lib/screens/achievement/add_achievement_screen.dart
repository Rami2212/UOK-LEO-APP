...
class _AddAchievementScreenState extends State<AddAchievementScreen> {
  ...
  void _submitAchievement() async {
    if (_formKey.currentState!.validate()) {
      ...
      bool success = await _achievementRepository.addAchievement(newAchievement);

      if (success) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Achievement added successfully")));
        Navigator.pop(context);
      } else {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Failed to add achievement")));
      }
    }
  }
